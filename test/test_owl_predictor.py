...
import torch
import PIL.Image
from ..encoder.owl_predictor import OwlPredictor
from ..encoder.image_preprocessor import ImagePreprocessor
...
def test_owl_predictor_encode_text():
    ...
    text_encode_output = owl_predictor.encode_text(["a car", "a dog"])
...
def test_owl_predictor_encode_image():
    ...
    image = PIL.Image.open("../assets/bellevue.jpg")
...
def test_owl_predictor_decode():
    ...
    image = PIL.Image.open("../assets/cityscapes.png")
    ...
    text_output = owl_predictor.encode_text(["a person"])
...
def test_owl_predictor_decode_multiple_images():
    ...
    text_output = owl_predictor.encode_text(["a person", "a car"])
