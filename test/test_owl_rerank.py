...
if __name__ == "__main__":
    ...
    parser.add_argument("--image", type=str, default="../assets/cityscapes.png")
    parser.add_argument("--prompt", type=str, default="[a man with white t-shirt]")
    parser.add_argument("--threshold", type=str, default="0.1,0.1")
    parser.add_argument("--output", type=str, default="../assets/cityscapes_out.jpg")
    parser.add_argument("--model", type=str, default="google/owlvit-base-patch32")
    parser.add_argument("--image_encoder_engine", type=str, default="../model/owl_image_encoder_patch32.engine")
